...
struct servo *servo_create(struct servo_config *cfg)
{
	...
	servo_step_threshold = cfg->servo_step_threshold;
	...
	servo_first_step_threshold = cfg->servo_first_step_threshold;
